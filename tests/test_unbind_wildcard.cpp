...
void test_address_wildcard_ipv4 ()
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_getsockopt (sb, SZMQ_LAST_ENDPOINT, bind_endpoint, &endpoint_len));
...
void test_address_wildcard_ipv6 ()
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_setsockopt (sb, SZMQ_IPV6, &ipv6, sizeof (int)));
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_setsockopt (sc, SZMQ_IPV6, &ipv6, sizeof (int)));
...
void test_port_wildcard_ipv4_address ()
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_getsockopt (sb, SZMQ_LAST_ENDPOINT, endpoint, &endpoint_len));
