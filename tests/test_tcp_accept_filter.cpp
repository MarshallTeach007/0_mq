...
void test_bad_filter_string (const char *const filter_)
{
    ...
    TEST_ASSERT_FAILURE_ERRNO (EINVAL,
                               zmq_setsockopt (socket, SZMQ_TCP_ACCEPT_FILTER,
...
void test_clear ()
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_setsockopt (bind_socket, SZMQ_TCP_ACCEPT_FILTER, NULL, 0));

#if 0
    // XXX Shouldn't this work as well?
    const char empty_filter[] = "";
    TEST_ASSERT_SUCCESS_ERRNO (zmq_setsockopt (
      socket, SZMQ_TCP_ACCEPT_FILTER, empty_filter, strlen (empty_filter)));
#endif
...
void test_set_non_matching_and_clear ()
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (
      zmq_setsockopt (bind_socket, SZMQ_TCP_ACCEPT_FILTER, non_matching_filter,
...
void test_set_matching (const char *const filter_)
{
    ...
    TEST_ASSERT_SUCCESS_ERRNO (zmq_setsockopt (
      bind_socket, SZMQ_TCP_ACCEPT_FILTER, filter_, strlen (filter_)));
