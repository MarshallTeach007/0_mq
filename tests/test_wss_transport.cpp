...
void test_roundtrip ()
{
    ...
    zmq_setsockopt (sb, SZMQ_WSS_CERT_PEM, cert, strlen (cert));
    zmq_setsockopt (sb, SZMQ_WSS_KEY_PEM, key, strlen (key));
    ...
    zmq_setsockopt (sc, SZMQ_WSS_TRUST_PEM, cert, strlen (cert));
    zmq_setsockopt (sc, SZMQ_WSS_HOSTNAME, "zeromq.org", strlen ("zeromq.org"));
