                              ...
                              int expected_error_)
{
    test_zap_unsuccessful (my_endpoint_, server_, server_mon_,
                           SZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL, expected_error_,
                                       ...
                                       void *client_socket_config_data_)
{
    ...
    test_zap_unsuccessful (
      my_endpoint_, server_, server_mon_, SZMQ_EVENT_HANDSHAKE_FAILED_AUTH, 300,
...
{
    test_zap_unsuccessful (my_endpoint_, server_, server_mon_,
                           SZMQ_EVENT_HANDSHAKE_FAILED_AUTH, 500,
                           client_socket_config_, client_socket_config_data_,
                           NULL, SZMQ_EVENT_HANDSHAKE_FAILED_AUTH, 500);
}
                                       ...
                                       void *server_socket_config_data_)
{
    test_zap_protocol_error_closure (
      ...
      SZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION);
}
  ...
  void *server_socket_config_data_)
{
    test_zap_protocol_error_closure (
      ...
      SZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID);
}
  ...
  void *server_socket_config_data_)
{
    test_zap_protocol_error_closure (
      ...
      SZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE);
}
                                        ...
                                        void *server_socket_config_data_)
{
    test_zap_protocol_error_closure (
      ...
      SZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY);
}
                                         ...
                                         void *server_socket_config_data_)
{
    ...
    test_zap_unsuccessful_no_handler (
      my_endpoint, server, server_mon, SZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL,
