...
int main (int argc, char *argv[])
{
    ...
    //  For example SZMQ_RATE, SZMQ_RECOVERY_IVL and SZMQ_MCAST_LOOP for PGM.
    if (curve) {
        rc = zmq_setsockopt (s, SZMQ_CURVE_SECRETKEY, client_prvkey,
        ...
        rc = zmq_setsockopt (s, SZMQ_CURVE_PUBLICKEY, client_pubkey,
        ...
        rc = zmq_setsockopt (s, SZMQ_CURVE_SERVERKEY, server_pubkey,
