...
class test_ip_resolver_t SZMQ_FINAL : public zmq::ip_resolver_t
{
  public:
  ...
  protected:
    ...
    int do_getaddrinfo (const char *node_,
                        ...
                        struct addrinfo **res_) SZMQ_FINAL
    {
    ...
    unsigned int do_if_nametoindex (const char *ifname_) SZMQ_FINAL
    {
