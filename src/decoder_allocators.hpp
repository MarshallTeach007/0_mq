...
#ifndef __SZMQ_DECODER_ALLOCATORS_HPP_INCLUDED__
#define __SZMQ_DECODER_ALLOCATORS_HPP_INCLUDED__
...
// Static buffer policy.
    ...
    public:
        ...
        void resize(std::size_t new_size_) { LIBSZMQ_UNUSED (new_size_); }

    private:
        std::size_t _buf_size;
        unsigned char *_buf;

    SZMQ_NON_COPYABLE_NOR_MOVABLE (c_single_allocator)
    };
