...
#ifndef __SZMQ_ATOMIC_COUNTER_HPP_INCLUDED__
#define __SZMQ_ATOMIC_COUNTER_HPP_INCLUDED__

#include "stdint.hpp"
#include "macros.hpp"

#if defined SZMQ_FORCE_MUTEXES
#define SZMQ_ATOMIC_COUNTER_MUTEX
#elif (defined __cplusplus && __cplusplus >= 201103L)                          \
 || (defined _MSC_VER && _MSC_VER >= 1900)
#define SZMQ_ATOMIC_COUNTER_CXX11
#elif defined SZMQ_HAVE_ATOMIC_INTRINSICS
#define SZMQ_ATOMIC_COUNTER_INTRINSIC
#elif (defined __i386__ || defined __x86_64__) && defined __GNUC__
#define SZMQ_ATOMIC_COUNTER_X86
#elif defined __ARM_ARCH_7A__ && defined __GNUC__
#define SZMQ_ATOMIC_COUNTER_ARM
#elif defined SZMQ_HAVE_WINDOWS
#define SZMQ_ATOMIC_COUNTER_WINDOWS
#elif (defined SZMQ_HAVE_SOLARIS || defined SZMQ_HAVE_NETBSD                     \
       || defined SZMQ_HAVE_GNU)
#define SZMQ_ATOMIC_COUNTER_ATOMIC_H
#elif defined __tile__
#define SZMQ_ATOMIC_COUNTER_TILE
#else
#define SZMQ_ATOMIC_COUNTER_MUTEX
#endif

#if defined SZMQ_ATOMIC_COUNTER_MUTEX

#include "mutex.hpp"

#elif defined SZMQ_ATOMIC_COUNTER_CXX11
#include <atomic>
#elif defined SZMQ_ATOMIC_COUNTER_WINDOWS
#include "windows.hpp"
#elif defined SZMQ_ATOMIC_COUNTER_ATOMIC_H
#include <atomic.h>
#elif defined SZMQ_ATOMIC_COUNTER_TILE
...
//  mutexes).
    ...
    public:
        ...
        atomic_counter_t(integer_t value_ = 0) SZMQ_NOEXCEPT: _value(value_) {}

        //  Set counter _value (not thread-safe).
        void set(integer_t value_) SZMQ_NOEXCEPT { _value = value_; }

        //  Atomic addition. Returns the old _value.
        integer_t add(integer_t increment_) SZMQ_NOEXCEPT
        {
            integer_t old_value;

#if defined SZMQ_ATOMIC_COUNTER_WINDOWS
            old_value = InterlockedExchangeAdd ((LONG *) &_value, increment_);
#elif defined SZMQ_ATOMIC_COUNTER_INTRINSIC
...
#elif defined SZMQ_ATOMIC_COUNTER_X86
            __asm__ volatile("lock; xadd %0, %1 \n\t"
                             : "=r"(old_value), "=m"(_value)
                             : "0"(increment_), "m"(_value)
                             : "cc", "memory");
#elif defined SZMQ_ATOMIC_COUNTER_ARM
            integer_t flag, tmp;
            __asm__ volatile("       dmb     sy\n\t"
                             ...
                             : "cc");
#elif defined SZMQ_ATOMIC_COUNTER_MUTEX
            sync.lock();
            old_value = _value;
            _value += increment_;
            sync.unlock();
...
#error atomic_counter is not implemented for this platform
        ...
        bool sub(integer_t decrement_) SZMQ_NOEXCEPT
        {
#if defined SZMQ_ATOMIC_COUNTER_WINDOWS
...
#error atomic_counter is not implemented for this platform
        ...
        integer_t get() const SZMQ_NOEXCEPT { return _value; }

    private:
#if defined SZMQ_ATOMIC_COUNTER_CXX11
...
#if !defined SZMQ_ATOMIC_COUNTER_CXX11
    SZMQ_NON_COPYABLE_NOR_MOVABLE (atomic_counter_t)
...
#undef SZMQ_ATOMIC_COUNTER_MUTEX
#undef SZMQ_ATOMIC_COUNTER_INTRINSIC
#undef SZMQ_ATOMIC_COUNTER_CXX11
#undef SZMQ_ATOMIC_COUNTER_X86
#undef SZMQ_ATOMIC_COUNTER_ARM
#undef SZMQ_ATOMIC_COUNTER_WINDOWS
#undef SZMQ_ATOMIC_COUNTER_ATOMIC_H
#undef SZMQ_ATOMIC_COUNTER_TILE
