...
#ifndef __SZMQ_SOCKET_BASE_HPP_INCLUDED__
#define __SZMQ_SOCKET_BASE_HPP_INCLUDED__
...
namespace zmq {
    ...
    public:
        ...
        void in_event() SZMQ_FINAL;

        void out_event() SZMQ_FINAL;

        void timer_event(int id_) SZMQ_FINAL;

        //  i_pipe_events interface implementation.
        void read_activated(pipe_t *pipe_) SZMQ_FINAL;

        void write_activated(pipe_t *pipe_) SZMQ_FINAL;

        void hiccuped(pipe_t *pipe_) SZMQ_FINAL;

        void pipe_terminated(pipe_t *pipe_) SZMQ_FINAL;
        ...
        //  Request for pipes statistics - will generate a SZMQ_EVENT_PIPES_STATS
    ...
    protected:
        ...
        //  options for the particular socket type. If not so, SZMQ_FINAL this
        //  method.
        virtual int
        ...
        void process_destroy() SZMQ_FINAL;
    ...
    private:
        ...
        void process_stop() SZMQ_FINAL;

        void process_bind(zmq::pipe_t *pipe_) SZMQ_FINAL;

        void
        process_pipe_stats_publish(uint64_t outbound_queue_count_,
                                   uint64_t inbound_queue_count_,
                                   endpoint_uri_pair_t *endpoint_pair_) SZMQ_FINAL;

        void process_term(int linger_) SZMQ_FINAL;

        void process_term_endpoint(std::string *endpoint_) SZMQ_FINAL;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (socket_base_t)
    ...
    protected:
        ...
        ~routing_socket_base_t() SZMQ_OVERRIDE;
        ...
        void xwrite_activated(pipe_t *pipe_) SZMQ_FINAL;
