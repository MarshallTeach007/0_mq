...
#ifndef __SZMQ_ENCODER_HPP_INCLUDED__
#define __SZMQ_ENCODER_HPP_INCLUDED__
...
//  state machine actions.
    ...
    public:
        ...
        ~encoder_base_t() SZMQ_OVERRIDE { free(_buf); }

        //  The function returns a batch of binary data. The data
        //  are filled to a supplied buffer. If no buffer is supplied (data_
        //  points to NULL) decoder object will provide buffer of its own.
        size_t encode(unsigned char **data_, size_t size_) SZMQ_FINAL
        {
        ...
        void load_msg(msg_t *msg_) SZMQ_FINAL
        {
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (encoder_base_t)
    };
}
