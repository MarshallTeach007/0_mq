...
#ifndef __SZMQ_STREAM_ENGINE_BASE_HPP_INCLUDED__
#define __SZMQ_STREAM_ENGINE_BASE_HPP_INCLUDED__
...
//  e.g. TCP socket or an UNIX domain socket.
    ...
    public:
        ...
        ~stream_engine_base_t() SZMQ_OVERRIDE;

        //  i_engine interface implementation.
        bool has_handshake_stage() SZMQ_FINAL { return _has_handshake_stage; };

        void plug(zmq::io_thread_t *io_thread_,
                  zmq::session_base_t *session_) SZMQ_FINAL;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (stream_engine_base_t)
    };
}
