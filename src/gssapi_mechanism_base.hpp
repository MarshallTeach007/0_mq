...
#ifndef __SZMQ_GSSAPI_MECHANISM_BASE_HPP_INCLUDED__
#define __SZMQ_GSSAPI_MECHANISM_BASE_HPP_INCLUDED__
...
class gssapi_mechanism_base_t : public virtual mechanism_base_t
{
  public:
    ...
    ~gssapi_mechanism_base_t () SZMQ_OVERRIDE = 0;
  ...
  protected:
    ...
    //  Convert SZMQ_GSSAPI_NT values to GSSAPI name_type
