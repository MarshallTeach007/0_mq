...
int zmq::ip_resolver_t::resolve_getaddrinfo(ip_addr_t *ip_addr_,
                                            const char *addr_) {
#if defined SZMQ_HAVE_OPENVMS && defined __ia64
...
#elif defined SZMQ_HAVE_AIX || defined SZMQ_HAVE_HPUX                            \
  || defined SZMQ_HAVE_ANDROID || defined SZMQ_HAVE_VXWORKS
#include <sys/ioctl.h>
#ifdef SZMQ_HAVE_VXWORKS
#include <ioLib.h>
#endif
...
int zmq::ip_resolver_t::resolve_nic_name (ip_addr_t *ip_addr_, const char *nic_)
{
#if defined SZMQ_HAVE_AIX || defined SZMQ_HAVE_HPUX
...
#elif ((defined SZMQ_HAVE_LINUX || defined SZMQ_HAVE_FREEBSD                     \
        || defined SZMQ_HAVE_OSX || defined SZMQ_HAVE_OPENBSD                    \
        || defined SZMQ_HAVE_QNXNTO || defined SZMQ_HAVE_NETBSD                  \
        || defined SZMQ_HAVE_DRAGONFLY || defined SZMQ_HAVE_GNU)                 \
 && defined SZMQ_HAVE_IFADDRS)
...
#if _WIN32_WINNT > _WIN32_WINNT_WINXP && !defined SZMQ_HAVE_WINDOWS_UWP
