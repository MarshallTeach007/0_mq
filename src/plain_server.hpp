...
#ifndef __SZMQ_PLAIN_SERVER_HPP_INCLUDED__
#define __SZMQ_PLAIN_SERVER_HPP_INCLUDED__
...
namespace zmq {
    ...
    class plain_server_t SZMQ_FINAL : public zap_client_common_handshake_t {
    public:
