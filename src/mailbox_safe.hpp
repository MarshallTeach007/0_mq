...
#ifndef __SZMQ_MAILBOX_SAFE_HPP_INCLUDED__
#define __SZMQ_MAILBOX_SAFE_HPP_INCLUDED__
...
namespace zmq {
    class mailbox_safe_t SZMQ_FINAL : public i_mailbox {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (mailbox_safe_t)
    };
}
