...
#ifndef __SZMQ_SOCKET_POLLING_UTIL_HPP_INCLUDED__
#define __SZMQ_SOCKET_POLLING_UTIL_HPP_INCLUDED__
...
namespace zmq {
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (fast_vector_t)
    };
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (resizable_fast_vector_t)
    };
 ...
 || defined SZMQ_HAVE_PPOLL
    ...
    class optimized_fd_set_t
    {
      ...
      private:
        fast_vector_t<SOCKET, 1 + SZMQ_POLLITEMS_DFLT> _fd_set;
    };
    ...
    class resizable_optimized_fd_set_t
    {
      ...
      private:
        resizable_fast_vector_t<SOCKET, 1 + SZMQ_POLLITEMS_DFLT> _fd_set;
    };
#else
    class optimized_fd_set_t
    {
