...
#ifndef __SZMQ_GSSAPI_CLIENT_HPP_INCLUDED__
#define __SZMQ_GSSAPI_CLIENT_HPP_INCLUDED__
...
class gssapi_client_t SZMQ_FINAL : public gssapi_mechanism_base_t
{
  public:
    gssapi_client_t (session_base_t *session_, const options_t &options_);
    ~gssapi_client_t () SZMQ_FINAL;
