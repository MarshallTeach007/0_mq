...
#ifndef __SZMQ_ROUTER_HPP_INCLUDED__
#define __SZMQ_ROUTER_HPP_INCLUDED__
...
//  TODO: This class uses O(n) scheduling. Rewrite it to use O(1) algorithm.
    ...
    public:
        ...
        int get_peer_state(const void *routing_id_,
                           size_t routing_id_size_) const SZMQ_FINAL;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (router_t)
    };
}
