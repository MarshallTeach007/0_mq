...
#ifndef __SZMQ_PGM_SENDER_HPP_INCLUDED__
#define __SZMQ_PGM_SENDER_HPP_INCLUDED__
...
class pgm_sender_t SZMQ_FINAL : public io_object_t, public i_engine
{
  public:
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (pgm_sender_t)
};
}
#endif
