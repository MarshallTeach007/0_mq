...
#ifndef __SZMQ_EPOLL_HPP_INCLUDED__
#define __SZMQ_EPOLL_HPP_INCLUDED__
...
class epoll_t SZMQ_FINAL : public worker_poller_base_t
{
  public:
    typedef void *handle_t;

    epoll_t (const thread_ctx_t &ctx_);
    ~epoll_t () SZMQ_OVERRIDE;
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (epoll_t)
};
