...
#ifndef __SZMQ_KQUEUE_HPP_INCLUDED__
#define __SZMQ_KQUEUE_HPP_INCLUDED__
...
class kqueue_t SZMQ_FINAL : public worker_poller_base_t
{
  public:
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (kqueue_t)
