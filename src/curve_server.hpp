...
#ifndef __SZMQ_CURVE_SERVER_HPP_INCLUDED__
#define __SZMQ_CURVE_SERVER_HPP_INCLUDED__
...
#endif
class curve_server_t SZMQ_FINAL : public zap_client_common_handshake_t,
