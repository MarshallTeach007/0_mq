...
#ifndef __SZMQ_IO_THREAD_HPP_INCLUDED__
#define __SZMQ_IO_THREAD_HPP_INCLUDED__
...
//  are implemented in separate "polling objects".
    ...
    class io_thread_t SZMQ_FINAL : public object_t, public i_poll_events {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (io_thread_t)
    };
}
