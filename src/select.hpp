...
#ifndef __SZMQ_SELECT_HPP_INCLUDED__
#define __SZMQ_SELECT_HPP_INCLUDED__

//  poller.hpp decides which polling mechanism to use.
#include "poller.hpp"

#if defined SZMQ_IOTHREAD_POLLER_USE_SELECT
...
class select_t SZMQ_FINAL : public worker_poller_base_t
{
  public:
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (select_t)
};
