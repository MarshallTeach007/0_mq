...
#ifndef __SZMQ_REQ_HPP_INCLUDED__
#define __SZMQ_REQ_HPP_INCLUDED__
...
namespace zmq {
    ...
    class req_t SZMQ_FINAL : public dealer_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (req_t)
    };

    class req_session_t SZMQ_FINAL : public session_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (req_session_t)
    };
}
