...
#ifndef __SZMQ_CURVE_MECHANISM_BASE_HPP_INCLUDED__
#define __SZMQ_CURVE_MECHANISM_BASE_HPP_INCLUDED__
...
class curve_encoding_t
{
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (curve_encoding_t)
};
                               ...
                               public curve_encoding_t
{
  public:
    ...
    int encode (msg_t *msg_) SZMQ_OVERRIDE;
    int decode (msg_t *msg_) SZMQ_OVERRIDE;
};
}
