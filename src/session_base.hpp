...
#ifndef __SZMQ_SESSION_BASE_HPP_INCLUDED__
#define __SZMQ_SESSION_BASE_HPP_INCLUDED__
...
namespace zmq {
    ...
    public:
        ...
        void read_activated(zmq::pipe_t *pipe_) SZMQ_FINAL;

        void write_activated(zmq::pipe_t *pipe_) SZMQ_FINAL;

        void hiccuped(zmq::pipe_t *pipe_) SZMQ_FINAL;

        void pipe_terminated(zmq::pipe_t *pipe_) SZMQ_FINAL;
    ...
    private:
        ...
        void process_plug() SZMQ_FINAL;

        void process_attach(zmq::i_engine *engine_) SZMQ_FINAL;

        void process_term(int linger_) SZMQ_FINAL;

        void process_conn_failed() SZMQ_OVERRIDE;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (session_base_t)
    };

    class hello_msg_session_t SZMQ_FINAL : public session_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (hello_msg_session_t)
    };
}
