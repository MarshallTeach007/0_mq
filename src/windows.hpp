...
#ifndef __SZMQ_WINDOWS_HPP_INCLUDED__
#define __SZMQ_WINDOWS_HPP_INCLUDED__
...
#if !defined _WIN32_WINNT && !defined SZMQ_HAVE_WINDOWS_UWP
...
#if defined SZMQ_IOTHREAD_POLLER_USE_POLL || defined SZMQ_POLL_BASED_ON_POLL
...
//  Fix #3949.
#if defined(SZMQ_HAVE_IPC) && !defined(SZMQ_HAVE_STRUCT_SOCKADDR_UN)
struct sockaddr_un
{
