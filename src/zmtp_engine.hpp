...
#ifndef __SZMQ_ZMTP_ENGINE_HPP_INCLUDED__
#define __SZMQ_ZMTP_ENGINE_HPP_INCLUDED__
...
//  e.g. TCP socket or an UNIX domain socket.
    ...
    class zmtp_engine_t SZMQ_FINAL : public stream_engine_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (zmtp_engine_t)
    };
}
