...
#ifndef __SZMQ_ZAP_CLIENT_HPP_INCLUDED__
#define __SZMQ_ZAP_CLIENT_HPP_INCLUDED__
...
namespace zmq {
    ...
    protected:
        ...
        int receive_and_process_zap_reply() SZMQ_FINAL;

        void handle_zap_status_code() SZMQ_FINAL;
