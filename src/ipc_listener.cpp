...
#ifdef _MSC_VER
#ifdef SZMQ_IOTHREAD_POLLER_USE_SELECT
...
#include <sys/ucred.h>
#endif
#ifdef SZMQ_HAVE_SO_PEERCRED
#include <sys/types.h>
#include <pwd.h>
#include <grp.h>
#if defined SZMQ_HAVE_OPENBSD
...
zmq::fd_t zmq::ipc_listener_t::accept ()
{
    ...
    zmq_assert (_s != retired_fd);
#if defined SZMQ_HAVE_SOCK_CLOEXEC && defined HAVE_ACCEPT4
