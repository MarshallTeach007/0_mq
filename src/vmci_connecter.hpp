...
#ifndef __SZMQ_VMCI_CONNECTER_HPP_INCLUDED__
#define __SZMQ_VMCI_CONNECTER_HPP_INCLUDED__
...
class vmci_connecter_t SZMQ_FINAL : public stream_connecter_base_t
{
  public:
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (vmci_connecter_t)
};
}
