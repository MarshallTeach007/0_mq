...
#ifndef __SZMQ_STREAM_HPP_INCLUDED__
#define __SZMQ_STREAM_HPP_INCLUDED__
...
namespace zmq {
    ...
    class stream_t SZMQ_FINAL : public routing_socket_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (stream_t)
    };
}
