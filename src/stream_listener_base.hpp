...
#ifndef __SZMQ_STREAM_LISTENER_BASE_HPP_INCLUDED__
#define __SZMQ_STREAM_LISTENER_BASE_HPP_INCLUDED__
...
namespace zmq {
    ...
    public:
        ...
        ~stream_listener_base_t() SZMQ_OVERRIDE;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (stream_listener_base_t)
    };
}
