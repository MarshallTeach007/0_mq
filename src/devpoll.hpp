...
#ifndef __SZMQ_DEVPOLL_HPP_INCLUDED__
#define __SZMQ_DEVPOLL_HPP_INCLUDED__

//  poller.hpp decides which polling mechanism to use.
#include "poller.hpp"

#if defined SZMQ_IOTHREAD_POLLER_USE_DEVPOLL
...
class devpoll_t SZMQ_FINAL : public worker_poller_base_t
{
  public:
    typedef fd_t handle_t;

    devpoll_t (const thread_ctx_t &ctx_);
    ~devpoll_t () SZMQ_FINAL;
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (devpoll_t)
};
