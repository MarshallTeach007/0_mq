...
#ifndef __SZMQ_YPIPE_HPP_INCLUDED__
#define __SZMQ_YPIPE_HPP_INCLUDED__
...
//  perform next memory allocation.
    ...
    class ypipe_t SZMQ_FINAL : public ypipe_base_t<T> {
    public:
...
#pragma message restore
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (ypipe_t)
    };
}
