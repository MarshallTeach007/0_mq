...
#ifndef __SZMQ_YQUEUE_HPP_INCLUDED__
#define __SZMQ_YQUEUE_HPP_INCLUDED__
...
//  actual memory allocation is required).
    ...
    template <typename T, int N, size_t ALIGN = SZMQ_CACHELINE_SIZE> class yqueue_t
#else
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (yqueue_t)
    };
}
