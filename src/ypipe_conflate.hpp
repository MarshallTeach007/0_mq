...
#ifndef __SZMQ_YPIPE_CONFLATE_HPP_INCLUDED__
#define __SZMQ_YPIPE_CONFLATE_HPP_INCLUDED__
...
//  around the reader being asleep (see 'c' pointer being NULL in ypipe.hpp)
    ...
    template<typename T>
    class ypipe_conflate_t SZMQ_FINAL : public ypipe_base_t<T> {
    public:
...
#pragma message restore
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (ypipe_conflate_t)
    };
}
