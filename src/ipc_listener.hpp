...
#ifndef __SZMQ_IPC_LISTENER_HPP_INCLUDED__
#define __SZMQ_IPC_LISTENER_HPP_INCLUDED__
...
namespace zmq
{
class ipc_listener_t SZMQ_FINAL : public stream_listener_base_t
{
  public:
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (ipc_listener_t)
};
}
