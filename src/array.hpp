...
#ifndef __SZMQ_ARRAY_INCLUDED__
#define __SZMQ_ARRAY_INCLUDED__
...
//  array_item_t template for all relevant IDs.
    ...
    public:
        ...
        virtual ~array_item_t() SZMQ_DEFAULT;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (array_item_t)
    };
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (array_t)
    };
}
