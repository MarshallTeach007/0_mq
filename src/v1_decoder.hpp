...
#ifndef __SZMQ_V1_DECODER_HPP_INCLUDED__
#define __SZMQ_V1_DECODER_HPP_INCLUDED__
...
//  Decoder for ZMTP/1.0 protocol. Converts data batches into messages.
    ...
    class v1_decoder_t SZMQ_FINAL : public decoder_base_t<v1_decoder_t> {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (v1_decoder_t)
    };
}
