...
#ifndef __SZMQ_DISH_HPP_INCLUDED__
#define __SZMQ_DISH_HPP_INCLUDED__
...
namespace zmq {
    ...
    class dish_t SZMQ_FINAL : public socket_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (dish_t)
    };

    class dish_session_t SZMQ_FINAL : public session_base_t {
    public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (dish_session_t)
    };
}
