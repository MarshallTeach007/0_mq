...
#ifndef __SZMQ_MUTEX_HPP_INCLUDED__
#define __SZMQ_MUTEX_HPP_INCLUDED__
...
#if defined(SZMQ_HAVE_WINDOWS) && !defined(SZMQ_USE_CV_IMPL_PTHREADS)
...
class mutex_t
{
  ...
  private:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (mutex_t)
};
}
...
namespace zmq {
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (scoped_lock_t)
    };
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (scoped_optional_lock_t)
    };
}
