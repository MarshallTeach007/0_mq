...
#ifndef __SZMQ_CONDITON_VARIABLE_HPP_INCLUDED__
#define __SZMQ_CONDITON_VARIABLE_HPP_INCLUDED__
...
#if defined(SZMQ_USE_CV_IMPL_NONE)
...
class condition_variable_t
{
  public:
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (condition_variable_t)
};
}

#elif defined(SZMQ_USE_CV_IMPL_WIN32API)
...
#elif defined(SZMQ_USE_CV_IMPL_STL11)
...
{
  public:
    condition_variable_t () SZMQ_DEFAULT;
...
#elif defined(SZMQ_USE_CV_IMPL_VXWORKS)
...
{
  public:
    inline condition_variable_t () SZMQ_DEFAULT;
...
#elif defined(SZMQ_USE_CV_IMPL_PTHREADS)
...
#if !defined(SZMQ_HAVE_OSX) && !defined(ANDROID_LEGACY)
