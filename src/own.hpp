...
#ifndef __SZMQ_OWN_HPP_INCLUDED__
#define __SZMQ_OWN_HPP_INCLUDED__
...
//  It handles initialisation and destruction of such objects.
    ...
    protected:
        ...
        void process_term(int linger_) SZMQ_OVERRIDE;
    ...
    private:
        ...
        void process_own(own_t *object_) SZMQ_OVERRIDE;

        void process_term_req(own_t *object_) SZMQ_OVERRIDE;

        void process_term_ack() SZMQ_OVERRIDE;

        void process_seqnum() SZMQ_OVERRIDE;
    ...
    SZMQ_NON_COPYABLE_NOR_MOVABLE (own_t)
    };
}
